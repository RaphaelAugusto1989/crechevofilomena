    ...
    <div class="bg_galeria"> 
        <div class="container" id="Galeria"><!--INICIO DIV GALERIA-->
            <div class="row mt-5 p-3 bg_fundo justify-content-md-center">
                <?php
                    foreach($noticias as $value => $n) {
                ?>
                <h3 class="text-warning"><?= $noticias[$value]->titulo_noticia; ?></h3>
                <div class="row">
                    <div class="col col-lg-12 rounded p-3 m-2 bg-white">
                        <img src="<?= base_url($noticias[$value]->img_noticia);?>" class="img-fluid capas popupimage" alt="">
                        <br />
                        <br />
