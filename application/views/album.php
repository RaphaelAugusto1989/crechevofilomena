...
<body>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 align-middle">
                    <ul class="nav menu justify-content-end mt-4">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-purple" href="#NossaCreche">NOSSA CRECHE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-success" href="#Servicos">SERVIÇOS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-warning" href="#Galeria">GALERIA</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-orage" href="#Noticias">NOTÍCIAS</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-danger" href="#Contatos">CONTATOS</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                ...
                ?>
                    <div class="carousel-item">
                        <img class="d-block w-100" src="<?= base_url('assets/img/banners/'.$banner[$value]->img_banner) ?>" alt="Primeiro Slide">
                    </div>
                <?php
                    }
                ?>
    ...
    <div class="container mt-5 pt-5" id="NossaCreche"><!--INICIO DIV NOSSA CRECHE-->
        ...
        ?>
            <div class="col-lg-6">
                <img src="<?= base_url('assets/img/capa_creche.jpg');?>" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6">
    ...
    <div class="bg_galeria"> 
        <div class="container mt-5 pt-5" id="Galeria"><!--INICIO DIV GALERIA-->
            <div class="row mt-5 p-3 bg_fundo">
                ...
                ?>
                        <div class="col border border-info rounded p-3 m-2 bg-white">
                        <a href="<?= base_url('Galeria/AlbumCompleto/'.$galeria[$value]->id_album);?>" target="_blank" rel="noopener noreferrer">
                ...
                <div class="row float-right">
                    <a href=".modalGaleria" class="btn btn-primary" rel="modal:open">Mais álbuns...</a>
                </div>
            </div>
        </div>
    </div><!--FIM DIV GALERIA-->
    ...
    <div class="container mt-5 pt-5" id="Noticias"><!--INICIO DIV NOTICIAS-->
        <div class="row mt-5 p-3 bg_fundo">
            ...
            <div class="row">
                ...
                <div class="col border border-info rounded p-3 m-2 bg-white">
                    ...
                    <div class="col text-justify p-0">
                        ...
                        <p><?= $noticias[$value]->texto_noticia; ?></p> 
                    </div>
                    <a href="<?= site_url('');?>">veja mais...</a>
                </div>
                <?php
                    }  //FIM FOREACH
                ?>
            ...
            <div class="row float-right">
                <a href="" target="_blank" rel="noopener noreferrer" class="btn btn-primary">Todas as Notícias...</a>
            </div>
        </div>
